...
import seller from "../../asset/success.png";
...
const AdminDashboard = () => {
    ...
    const state = {
        series: [
            {
                name: "Orders",
                data: [13, 34, 45, 56, 76, 34, 23, 76, 87, 78],
            },
            {
                name: "Revenue",
                data: [77, 20, 34, 45, 76, 34, 23, 56, 87, 78],
            },
            {
                name: "Sellers",
                data: [67, 20, 34, 45, 34, 34, 23, 56, 87, 78],
            },
        ],
        options: {
            color: ["#181ee8", "#181ee8"],
                ...
                <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
                    <div className="w-full bg-primary p-4 rounded-md text-[#fff]">
                        <div className="flex justify-between items-center">
                            <h2 className="font-semibold text-[1.9rem] text-[#fff]">
                                Recent Seller Message
                            </h2>
                            <Link
                                to={"/admin/dashboard/chat-seller"}
                                className="font-semibold text-[1.4rem] text-[#fff]"
                            >
                                View All
                            </Link>
                        </div>
                        ...
                        <div className="flex flex-col gap-2 pt-6 text-[#fff] ">
                            <ol className="relative border-1 border-slate-600 ml-4">
                                {recentMessages.map((m) => (
                                    <li
                                        key={m._id}
                                        className="mb-[30px]  ml-6 "
                                    >
                                        <div className="flex absolute -left-6 shadow-lg justify-center items-center w-10 h-10 p-[2px] bg-[#4c7fe2] rounded-full z-10">
                                        ...
                                        <div className="p-3 bg-slate-800 rounded-lg border border-slate-600 shadow-sm">
                                            ...
                                            <div className="p-2 text-[1.3rem] font-normal bg-slate-700 rounded-lg border border-slate-800">
                                                {m.message}
                                            </div>
                                        </div>
                                    </li>
