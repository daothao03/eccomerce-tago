            ...
            <div className='w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6'>
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        <h1 className='flex justify-start font-roboto-slab text-[2rem] font-[800] text-black'>
                            TAGO.
                        </h1>
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>
                                Address : 2504 Ivins Avenue, Egg Harbor
                                Township, NJ 08234,
                            </li>
                ...
                <div className='w-4/12 lg:w-full lg:mt-6'>
                    <div className='w-full flex flex-col justify-start gap-5'>
                        ...
                        <span>
                            Get Email updates about tour latest and shop
                            specials offers
                        </span>
                        <div className='h-[50px] w-full relative flex'>
                            <input
                                className='h-full bg-transparent w-full px-3 outline-0 border rounded-[999px]'
                                type='text'
                                placeholder='Enter Your Email'
                            />
                            <button className='h-full bg-[#059473] text-white uppercase px-4 font-bold text-sm rounded-[999px]'>
                                Subscribe
                            </button>
                        </div>
