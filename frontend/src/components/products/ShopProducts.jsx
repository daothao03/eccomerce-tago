            ...
            {products.map((product) => (
                ...
                >
                    <div
                        className={
                            styles === "grid"
                                ? "w-full relative group h-[320px] md:h-[270px] xs:h-[170px] overflow-hidden"
                                : "md-lg:w-full relative group h-[210px] md:h-[270px] overflow-hidden"
                        }
                    >
                        {product.images && product.images.length > 0 ? (
                            <img
                                className='h-full rounded-md md:h-full xs:h-full w-[370px] object-cover'
                    ...
                    <div className='flex flex-col justify-between items-start flex-1 gap-1'>
                        <div>
                            <h3 className='font-normal  text-[13px] text-[#566363]'>
                                {product.brand}
                            </h3>
                            <h2 className='font-bold text-[1.1rem] w-[270px] line-clamp-2'>
                                {product.name}
                            </h2>
                        </div>
