...
import { get_data_dashboard } from "../../store/reducers/dashboardReducer";
...
const Index = () => {
    ...
    useEffect(() => {
        dispatch(get_data_dashboard(userInfo.id));
    }, []);
                            ...
                            <tbody>
                                {recentOrders.map((recentOrder) => (
                                    ...
                                    >
                                        ...
                                        >
                                            <Link
                                                to={`/dashboard/order/details/${recentOrder._id}`}
                                            >
